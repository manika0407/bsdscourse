...
//      "3fknpjdtrk.execute-api.us-west-2.amazonaws.com";  // <------ lambda api gateway invocation link
      "35.244.213.164"; // <----- google cloud load balancer ip
//      "35.229.52.207"; // <--- google cloud vm end point
//      "ec2-34-220-61-97.us-west-2.compute.amazonaws.com"; // <---- ec2 end point
//      "bsdsassignment2-load-balancer-2101220617.us-west-2.elb.amazonaws.com";  // <--- aws load balancer end point
//      "localhost";

  @Option(name = "-p", usage = "port used on server")
  private int serverPort =
      8080;
//  0; // <---- use for aws lambda

  @Option(name = "-u", usage = "uri for request")
  private String serverUri =
      "/bsdsassignment2-webapp/stepcounter";
//      "/prod/bsdsassignment2-webapp/stepcounter"; // <---- use for aws lambda
  ...
  @Option(name = "-l", usage = "enable debug logs")
  ...
  public static void main(String[] args)
    ...
    if (t.enableDebugLogs) {
      StepCounterObjects.DEBUG_LOG_ENABLED = true;
    }
