...
public class StepCounterLambdaRequest {
  ...
  public StepCounterLambdaRequest() {}
  ...
  public StepCounterLambdaRequest(String resource, String path, String httpMethod, Map<String, String> headers, Map<String, String> queryStringParameters, Map<String, String> pathParameters, Map<String, String> stageVariables, Context context, String body, boolean isBase64Encoded) {
  ...
  public String toString() {
    return "StepCounterLambdaRequest{" +
        "resource='" + resource + '\'' +
        ", path='" + path + '\'' +
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof StepCounterLambdaRequest)) return false;

    StepCounterLambdaRequest that = (StepCounterLambdaRequest) o;
