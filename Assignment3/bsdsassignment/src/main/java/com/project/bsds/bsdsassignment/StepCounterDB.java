...
public class StepCounterDB {
  ...
  private DataSource getDataSource() {
    if (USE_CONNECTION_POOLING) {
      ...
      mysqlDataSource.setUrl("jdbc:mysql://" + DB_ADDRESS + ":" + DB_PORT + "/" + DB_NAME);
      mysqlDataSource.setServerName(DB_ADDRESS);
      ...
      try {
        ...
        mysqlDataSource.setPrepStmtCacheSize(ST_CACHE_SIZE);
        mysqlDataSource.setPrepStmtCacheSqlLimit(10240);
