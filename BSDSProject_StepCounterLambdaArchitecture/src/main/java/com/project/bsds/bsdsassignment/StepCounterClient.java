...
public class StepCounterClient implements Closeable {
  ...
  public StepCounterClient(String baseUri) {
    ...
    this.client.setChunkedEncodingSize(0);
  }
...
//    StepCounterClient sc = new StepCounterClient("3fknpjdtrk.execute-api.us-west-2.amazonaws.com", 0, "/prod/bsdsassignment2-webapp/stepcounter");
//    StepCounterClient sc = new StepCounterClient("35.244.213.164", 8080, "/bsdsassignment2-webapp/stepcounter");
//    StepCounterClient sc = new StepCounterClient("35.229.52.207", 8080, "/bsdsassignment2-webapp/stepcounter");
    StepCounterClient sc = new StepCounterClient("34.208.226.226", 8080, "/bsdsassignment2-webapp/stepcounter");
